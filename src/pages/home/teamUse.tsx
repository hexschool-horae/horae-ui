...
export default function TeamUse() {
  const [companyList] = useState(['digg', 'reddit', 'wordPress', 'piedPiperPP', 'fontAwesome'])
  const [companyList2] = useState(['CSS3', 'stumble', 'google', 'piedPiper', 'slack', 'joomla'])
